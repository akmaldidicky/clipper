# ============================================================
# 🔥 SUBTITLE CLIPS V8.6.4
# Shorts Subtitle + Smart Keyword Highlight
# ============================================================
...
def find_keywords(words):
    ...
    for score, index in scored:
        ...
        # jangan highlight dua kata
        # yang berdempetan supaya tidak
        # terlalu rame
        if any(
            abs(index - x) <= 1
            for x in selected
